      ...
      <div class="row">
	      	...
	      	<div class="box box-info">
	            <div class="box-header with-border">
	              <h3 class="box-title">学生征信报告</h3>
	            </div>
	         
	            <form class="form-horizontal" method="post" action="searchCreditReport">
	              <div class="box-body">
	                <div class="form-group">
	                  ...
	                  <div class="col-sm-3">
	                   ...
	                   <div class="col-sm-3">
	                    <input type="text" class="form-control" id="studentNumber" name="studentNumber" placeholder="学号">
	                  </div>
	                  <div class="col-sm-3">
