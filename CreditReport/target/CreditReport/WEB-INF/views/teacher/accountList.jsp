                 ...
                 <td>${item.id}</td>
                  ...
                  <td>
                  	...
                  	<tr>
	                  	...
	                  	<td>
	                  	<form id="detailedInfo${item.id }">
	                  		<input type="hidden" name="userId" value="${item.id }"/>
	                  		<input type="text" class="btn btn-primary" size="10" onClick="detailInfo(${item.id})" value="详细信息"/>
	                  	</form>
	                  	</td>
                  	</tr>
                  	</table>
...
<script>
	...
	{
		var formId = 'detailedInfo'+id;	
		document.getElementById(formId).action='detailedUserById';
		document.getElementById(formId).submit();
	}
</script>
</body>
