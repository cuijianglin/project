            		...
            		<div class="col-sm-6">
              		<form role="form" action="finishInfo" method="post">
                		...
                		<div class="form-group">
                  			<label>真实姓名：</label>
                  			<input type="text" class="form-control" name="realName" placeholder="Enter ...">
                		</div>
                		  <div class="form-group">
                		  	<label>性别：</label>
			                  ...
			                  <div class="radio">
			                    <label>
			                      <input type="radio" name="sex" id="optionsRadios1" value="option1" checked>男
			                    </label>
			                  </div>
			                  <div class="radio">
			                    <label>
			                      <input type="radio" name="sex" id="optionsRadios2" value="option2">女
			                    </label>
			                  </div>
                		...
                		<div class="form-group">
                  			<label>工作单位:</label>
                  			<textarea class="form-control" name="workunit" rows="3" placeholder="Enter ..."></textarea>
                		</div>
