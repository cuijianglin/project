            		...
            		<div class="col-sm-6">
              		<form role="form" action="addAccount" method="post">
                		...
                		<div class="form-group">
                		  ...
                		  <div class="form-group">
                		  	<label>角色：</label>
                		  	<input type="radio" name="role" id="student" value="student" checked>学生
			               	<input type="radio" name="role" id="teacher" value="teacher" >教师
			                <input type="radio" name="role" id="manager" value="manager" >管理员
